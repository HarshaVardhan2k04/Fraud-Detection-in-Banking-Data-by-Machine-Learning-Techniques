...
ROOT_URLCONF = 'fraud_detection_in_banking_data.urls'
...
WSGI_APPLICATION = 'fraud_detection_in_banking_data.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'fraud_detection_in_banking_data',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
