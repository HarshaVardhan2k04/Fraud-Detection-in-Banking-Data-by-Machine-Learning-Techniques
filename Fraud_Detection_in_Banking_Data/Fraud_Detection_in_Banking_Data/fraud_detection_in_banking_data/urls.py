"""fraud_detection_in_banking_data URL Configuration
...
from fraud_detection_in_banking_data import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Bank_Fraud_Detection/$', remoteuser.Predict_Bank_Fraud_Detection, name="Predict_Bank_Fraud_Detection"),
    ...
    url(r'^View_Bank_Fraud_Detection_Ratio/$', serviceprovider.View_Bank_Fraud_Detection_Ratio, name="View_Bank_Fraud_Detection_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Bank_Fraud_Detection/$', serviceprovider.View_Prediction_Of_Bank_Fraud_Detection, name="View_Prediction_Of_Bank_Fraud_Detection"),
